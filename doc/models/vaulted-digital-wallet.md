...
```php
use PaypalServerSdkLib\Models\Builders\VaultedDigitalWalletBuilder;
...
$vaultedDigitalWallet = VaultedDigitalWalletBuilder::init()
    ->description('description4')
    ->usagePattern(UsagePattern::SUBSCRIPTION_PREPAID)
    ->shipping(
