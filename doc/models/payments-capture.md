...
| `id` | `?string` | Optional, Read-only | The PayPal-generated ID for the captured payment. | getId(): ?string | setId(?string id): void |
...
```php
use PaypalServerSdkLib\Models\Builders\PaymentsCaptureBuilder;
...
$paymentsCapture = PaymentsCaptureBuilder::init()
    ->statusDetails(
