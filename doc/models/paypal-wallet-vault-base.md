...
| `usageType` | [`?string(UsageType)`](../../doc/models/usage-type.md) | Optional | The usage type associated with the PayPal payment token.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `255`, *Pattern*: `^[0-9A-Z_]+$` | getUsageType(): ?string | setUsageType(?string usageType): void |
...
```php
use PaypalServerSdkLib\Models\Builders\PaypalWalletVaultBaseBuilder;
use PaypalServerSdkLib\Models\StoreInVaultInstruction;
use PaypalServerSdkLib\Models\UsagePattern;
use PaypalServerSdkLib\Models\UsageType;
use PaypalServerSdkLib\Models\PaypalPaymentTokenCustomerType;

$paypalWalletVaultBase = PaypalWalletVaultBaseBuilder::init()
