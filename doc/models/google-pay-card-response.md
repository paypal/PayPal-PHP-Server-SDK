...
| `lastDigits` | `?string` | Optional, Read-only | The last digits of the payment card.<br><br>**Constraints**: *Minimum Length*: `2`, *Maximum Length*: `4`, *Pattern*: `^[0-9]{2,4}$` | getLastDigits(): ?string | setLastDigits(?string lastDigits): void |
...
$googlePayCardResponse = GooglePayCardResponseBuilder::init()
    ->name('name2')
    ->type(CardType::STORE)
