...
```php
use PaypalServerSdkLib\Models\Builders\SubscriptionCustomerInformationBuilder;
...
$subscriptionCustomerInformation = SubscriptionCustomerInformationBuilder::init()
    ->id('id6')
