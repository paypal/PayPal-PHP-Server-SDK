...
| `id` | `?string` | Optional, Read-only | The PayPal-generated ID for the authorized payment. | getId(): ?string | setId(?string id): void |
...
```php
use PaypalServerSdkLib\Models\Builders\AuthorizationBuilder;
...
$authorization = AuthorizationBuilder::init()
    ->statusDetails(
