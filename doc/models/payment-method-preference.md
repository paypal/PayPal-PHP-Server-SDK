...
```php
use PaypalServerSdkLib\Models\Builders\PaymentMethodPreferenceBuilder;
use PaypalServerSdkLib\Models\PayeePaymentMethodPreference;
use PaypalServerSdkLib\Models\StandardEntryClassCode;

$paymentMethodPreference = PaymentMethodPreferenceBuilder::init()
