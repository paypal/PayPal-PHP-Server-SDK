...
|  --- | --- | --- | --- | --- | --- |
| `id` | `?string` | Optional, Read-only | The tracker id. | getId(): ?string | setId(?string id): void |
...
| `links` | [`?(LinkDescription[])`](../../doc/models/link-description.md) | Optional, Read-only | An array of request-related HATEOAS links. | getLinks(): ?array | setLinks(?array links): void |
...
$orderTrackerResponse = OrderTrackerResponseBuilder::init()
