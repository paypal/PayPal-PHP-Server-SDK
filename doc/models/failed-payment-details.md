...
| `reasonCode` | [`?string(ReasonCode)`](../../doc/models/reason-code.md) | Optional, Read-only | The reason code for the payment failure.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `120`, *Pattern*: `^[A-Z_]+$` | getReasonCode(): ?string | setReasonCode(?string reasonCode): void |
...
$failedPaymentDetails = FailedPaymentDetailsBuilder::init(
    MoneyBuilder::init(
        'currency_code6',
        'value0'
    )->build(),
